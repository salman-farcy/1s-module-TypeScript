...
const arraString = createArrayWithGeneric('farcy')
const arraNumber = createArrayWithGeneric(45)
const arraObject = createArrayWithGeneric({id: 23, name: "salman"})
console.log(arraString, arraNumber, arraObject)
